   ...
   /* @Test
    public void deleteFilmTest(){
      int film_id=1;
        ...
        verify(filmRepo, times(1)).deleteById(film_id);

    }*/
    @Test
    public void deleteTest(){

        Films user = new Films(999, "Pranya", "Pune",33 );
        filmService.deleteFilm(user.getFilmId());
        verify(filmRepo, times(1)).delete(user);
    }
